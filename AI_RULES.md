# Purpose
   ...
   **Explicitly Prohibited unless specifically requested:**
   ...
   This section defines the exact priority order the AI must follow whenever multiple instructions exist.
   ...
   9. Generated Solution

   Clearly state that higher-priority rules always override lower-priority rules.